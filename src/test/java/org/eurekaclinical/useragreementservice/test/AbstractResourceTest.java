...
public abstract class AbstractResourceTest extends JerseyTest {
    ...
    protected AppDescriptor configure() {
        ...
        clientConfig.getFeatures().put(JSONConfiguration.FEATURE_POJO_MAPPING,
                Boolean.TRUE);
        Class<ContextResolver<ObjectMapper>> contextResolverCls = getContextResolver();
        if (contextResolverCls != null) {
            clientConfig.getClasses().add(contextResolverCls);
        }
    ...
    protected abstract Class<ContextResolver<ObjectMapper>> getContextResolver();
